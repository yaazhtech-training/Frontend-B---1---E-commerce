...
const Category = ({handleAddWishList,handleRemoveWishList,wishList,cart,handleAddCart,searchInput}) => {
                    ...
                    <div className="bg-white p-5 text-center">
                      ...
                      {cart.some((cartItem) => cartItem.id === values.id) ? (
                        ...
                        <div className="pt-4 pb-2">
                          ...
                          <button
                            className=" bg-gradient-to-l from-neutral-200 to-red-500 order-none font-bold py-2 px-4 rounded-full w-full "
